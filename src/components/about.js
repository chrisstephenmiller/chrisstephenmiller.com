  ...
  render() {
    return (
      <div id="about" className="route">
        ...
        <br />
        <span className="subtitle text">A lifelong musician... After receiving a B.A. in Music Technology from Northwestern University in 2011, I worked as the director of customer support for <a className="about-info-link" target="_blank" rel="noopener noreferrer" href="https://www.http://wavemachinelabs.com/">WaveMachine Labs</a> Labs and <a className="about-info-link" target="_blank" rel="noopener noreferrer" href="https://www.reverb.com">Reverb.com</a>. These roles exposed me to the business and operational aspects of developing software and, before long, I wanted to build it myself.</span>
